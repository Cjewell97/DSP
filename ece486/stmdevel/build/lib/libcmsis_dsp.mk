...
VPATH = $(CMSISBASE)/DSP_Lib/Source/BasicMathFunctions/ \
        $(CMSISBASE)/DSP_Lib/Source/CommonTables/ \
        $(CMSISBASE)/DSP_Lib/Source/ComplexMathFunctions/ \
        $(CMSISBASE)/DSP_Lib/Source/ControllerFunctions/ \
        $(CMSISBASE)/DSP_Lib/Source/FastMathFunctions/ \
        $(CMSISBASE)/DSP_Lib/Source/FilteringFunctions/ \
        $(CMSISBASE)/DSP_Lib/Source/MatrixFunctions/ \
        $(CMSISBASE)/DSP_Lib/Source/StatisticsFunctions/ \
        $(CMSISBASE)/DSP_Lib/Source/SupportFunctions/ \
        $(CMSISBASE)/DSP_Lib/Source/TransformFunctions
